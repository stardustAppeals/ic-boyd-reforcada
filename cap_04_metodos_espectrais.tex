...
\]
Aplicando a transformada rápida de Fourier ao longo da variável temporal, obtêm-se aproximações discretas dos coeficientes \(\widehat{b}_k\). Em seguida, para cada modo \(k\), resolve-se o sistema \((ik\omega I-A)\widehat{U}_k=\widehat{b}_k\). Finalmente, a solução aproximada é reconstruída pela soma modal truncada.
