...
Em muitos problemas diferenciais, uma excitação periódica imposta ao sistema pode produzir respostas que também se repetem no tempo. O interesse, então, não é apenas verificar a existência desse regime, mas descrevê-lo ao longo de um ciclo completo e entender sua dependência em relação aos dados do problema.
